...
@NamedQueries({
    ...
    @NamedQuery(name = "Lembrete.findByTelefone", query = "SELECT l FROM Lembrete l WHERE l.telefone = :telefone"),
...
public class Lembrete implements Serializable {
    ...
    public Lembrete(Long id, long telefone, String titulo, int raio, double latitude, double longitude) {
        this.id = id;
